...
export default function SignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!turnstileToken) { setError('Verifying you are human… please wait a moment'); return }
    setLoading(true)
    setError(null)
    setSuggestions([])
    ...
    const res = await fetch('/api/auth/signup', {
      ...
      body: JSON.stringify({ username, email, password, country, turnstileToken }),
    })
    ...
    await signIn('credentials', { email, password, turnstileToken, callbackUrl: '/' })
  }
