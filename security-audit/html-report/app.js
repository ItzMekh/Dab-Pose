...
const FINDINGS = [
  ...
  { tag: "C-12", domain: "code", sev: "low", title: "Race ที่ signup uniqueness",
  ...
  { tag: "AU-02", domain: "auth", sev: "medium", title: "No CAPTCHA / bot challenge",
  ...
  { tag: "I-05", domain: "infra", sev: "info", title: ".env.local gitignored ✓",
    ...
    desc: "PASS",
    fix: "—" },
  { tag: "I-06", domain: "infra", sev: "medium", title: "Vercel WAF status visibility",
