...
const FINDINGS = [
  ...
  { tag: "C-02", closed: true, domain: "code", sev: "low", title: "Math.random() ใน username generation",
  ...
  { tag: "C-03", closed: true, domain: "code", sev: "info", title: "JSON-in-Redis member validation on read",
  ...
  { tag: "C-09", closed: true, domain: "code", sev: "info", title: "Dead code ใน csrf.ts",
  ...
  { tag: "C-14", closed: true, domain: "code", sev: "low", title: "History cursor ไม่ validate",
  ...
  { tag: "C-15", domain: "code", sev: "info", title: "Math.random() สำหรับ game timer delay",
    ...
    fix: "ไม่ต้องแก้" },
  { tag: "C-16", closed: true, domain: "code", sev: "info", title: "console.error ใช้สำหรับ production logging",
  ...
  { tag: "C-17", closed: true, domain: "code", sev: "low", title: "Password 8-char minimum + ไม่มี breach check",
  ...
  { tag: "AU-08", closed: true, domain: "auth", sev: "low", title: "Auth.js error/verifyRequest pages ไม่ตั้ง",
  ...
  { tag: "AU-10", closed: true, domain: "auth", sev: "low", title: "Username regex inconsistency",
  ...
  { tag: "I-07", closed: true, domain: "infra", sev: "info", title: "No pre-commit secret scan",
    files: ["—"],
  ...
  { tag: "DP-06", closed: true, domain: "dep", sev: "info", title: "No Node engine pin",
    files: ["package.json"],
